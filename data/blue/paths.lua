...
-- 1: RIVAL 1
	...
	{0, {12,12}, {c="a",a="Pallet Town"}, {c="viridianExp"}, {c="encounters",limit=5}, {c="trackEncounters",area="route1"}, {9,12}, {9,2}, {10,2}, {10,-1}},
	-- First encounters
	...
	-- Leaving home
	{0, {12,12}, {c="viridianBackupExp"}, {c="encounters",limit=7}, {9,12}, {9,2}, {10,2}, {10,-1}},
	-- The grass again!?
	{12, {10,35}, {10,30}, {8,30}, {8,24}, {12,24}, {12,20}, {9,20}, {9,14}, {14,14}, {s="dodgePalletBoy"}, {14,2}, {10,2}, {10,-1}},
	-- Out of Viridian City
	{1, {20,35}, {c="a",a="Tree Potion"}, {c="encounters",limit=10}, {20,28}, {19,28}, {19,20}, {19,4}, {17,4}, {s="grabTreePotion"}, {17,4}, {17, 0}, {17, -1}},
	-- To the Forest
	{13, {7,71}, {7,57}, {4,57}, {4,52}, {10,52}, {10,44}, {3,44}, {3,43}},
	-- Forest entrance
	{50, {4,7}, {c="a",a="Viridian Forest"}, {c="trackEncounters",area="forest"}, {4,1}, {5,1}, {5,0}},
	-- Viridian Forest
	{51, {17,47}, {17,43}, {26,43}, {26,34}, {25,34}, {25,32}, {27,32}, {27,20}, {25,20}, {25,12}, {s="take",dir="Up"}, {25,9}, {17,9}, {17,16}, {13,16}, {13,3}, {7,3}, {7,22}, {2,22}, {2,19}, {s="talk",dir="Up"}, {s="fightWeedle"}, {c="encounters",limit=nil}, {1,19}, {s="grabForestPotion"}, {1,18}, {1,16}, {c="potion",b=false}, {s="equipForBrock"}, {s="antidote"}, {s="potion",hp=12}, {1,5}, {1,-1}},
	-- Forest exit
	{47, {4,7}, {4,1}, {5,1}, {5,0}},
	-- Road to Pewter City
	...
	-- Brock
	{54, {4,13}, {c="a",a="Brock's Gym"}, {4,8}, {1,8}, {1,4}, {4,4}, {4,2}, {s="talk",dir="Up"}, {s="waitToFight"}, {s="split"}, {4,14}},
...
-- 3: BROCK
	...
	{2, {23,18}, {40,18}},
	-- Route 3
	{14, {0,10}, {c="a",a="Route 3"}, {c="catchFlier"}, {c="pp",on=true}, {c="trackEncounters",area="route3"}, {8,10}, {8,8}, {11,8}, {11,6}, {s="bugCatcher"}, {11,4}, {12,4}, {c="a",a="Shorts Kid"}, {s="potion",hp=24}, {13,4}, {s="talk",dir="Right"}, {s="shortsKid"}, {s="antidote"}, {13,5}, {c="a",a="Route 3"}, {s="potion",hp=4}, {18,5}, {s="talk",dir="Right"}, {s="waitToFight"}, {s="antidote"}, {18,6}, {22,6}, {22,5}, {23,5}, {s="potion",hp=4}, {24,5}, {s="talk",dir="Down"}, {27,5}, {27,9}, {s="catchFlierBackup"}, {37,8}, {37,5}, {49,5}, {49,10}, {57,10}, {57,8}, {59,8}, {59,-1}},
	-- Bat Cave
	{15, {9,16}, {c="pp",on=false}, {12,16}, {12,6}, {18,6}, {s="split"}, {18,5}},

-- 4: ROUTE 3

	-- Mt. Moon F1
	{59, {14,35}, {c="a",a="Mt. Moon"}, {c="trackEncounters",area="moon"}, {c="startMtMoon"}, {c="catchParas"}, {14,22}, {21,22}, {21,10}, {31,10}, {31,3}, {17,3}, {17,11}},
	-- Detour
	{60, {25,9}, {25,11}, {17,11}},
	-- Mega Punch
	{61, {25,9}, {28,9}, {28,5}, {s="take",dir="Right"}, {28,6}, {s="potion",hp=11,yolo=6,chain=true}, {s="teach",move="mega_punch",replace="tackle"}, {28,9}, {25,9}},
	-- Back Up
	{60, {17,11}, {25,9}, {25,11}},
	-- Mt. Moon F1
	{59, {17,11}, {17,17}, {6,17}, {6,5}, {5,5}},
	-- Mt. Moon B2
	{60, {5,5}, {5,17}, {21,17}},
	-- Mt. Moon B3
	{61, {21,17}, {22,17}, {23,17}, {23,14}, {27,14}, {27,16}, {33,16}, {33,14}, {36,14}, {36,24}, {32, 24}, {32,31}, {10,31}, {10,18}, {s="potion",hp=11,yolo=6}, {10,17}, {11,17}, {s="evolveInBattle"}, {12,17}, {12,9}, {s="potion",hp=7}, {s="talk",dir="Up"}, {s="fightGrimer"}, {s="antidote"}, {13,9}, {13,7}, {s="dialogue",dir="Up"}, {13,5}, {12,5}, {12,4}, {3,4}, {3,7}, {5,7}},
	-- Mt. Moon escape
	{60, {23,3}, {27,3}},
...
-- 5: MT. MOON
	...
	-- Misty
	{65, {4,13}, {c="a",a="Misty's Gym"}, {c="conserve",move="Mega-Punch"}, {4,8}, {2,8}, {2,5}, {7,5}, {7,3}, {6,3}, {5,3}, {s="debuff",{"goldeen",26}}, {s="potion",hp=45,topOff=true}, {5,2}, {s="talk",dir="Left"}, {s="debuff",{"staryu",26},{"starmie",28}}, {s="split"}, {5,3}, {7,3}, {7,5}, {5,5}, {5,14}},

-- 6: MISTY

	-- To the house
	{3, {30,20}, {16,20}, {s="potion",hp=35,chain=true}, {s="teach",move="bubblebeam",replace="tail_whip",close=true}, {s="dodgeCerulean",left=true}, {8,16}, {8,12}, {9,12}, {9,11}},
	-- In the house
	{230, {2,7}, {2,0}},
	-- Outback
	...
	{230, {2,1}, {2,8}},
	-- Rival 2
	{3, {9,12}, {c="a",a="Cerulean Rival"}, {c="conserve",move="Mega-Punch"}, {21,12}, {21,6}, {s="rivalSandAttack"}, {21,-1}},
	-- Nugget bridge
	{35, {11,35}, {c="a",a="Nugget Bridge"}, {11,32}, {s="talk",dir="Up"}, {10,32}, {10,30}, {s="antidote"}, {10,29}, {s="potion",hp=12,yolo=10}, {s="talk",dir="Up"}, {11,29}, {11,27}, {s="potion",hp=12,yolo=10}, {11,26}, {s="talk",dir="Up"}, {10,26}, {10,25}, {s="antidote",chain=true}, {s="potion",hp=12,yolo=10,close=true}, {10,23}, {s="talk",dir="Up"}, {11,23}, {11,21}, {s="antidote",chain=true}, {s="potion",hp=20,yolo=18,close=true}, {11,20}, {s="talk",dir="Up"}, {10,20}, {10,19}, {10,15}, {s="waitToFight"}, {s="antidote"}, {s="split"}, {10,8}, {20,8}},

-- 7: NUGGET BRIDGE

	-- To Bill's
	{36, {0,8}, {c="conserve",move=nil}, {9,8}, {9,7}, {11,7}, {11,9}, {14,9}, {14,6}, {15,6}, {15,4}, {17,4}, {17,7}, {18,7}, {s="talk",dir="Down"}, {s="waitToFight"}, {s="antidote",chain=true}, {s="potion",hp=12,yolo=10,close=true}, {20,7}, {20,8}, {22,8}, {22,6}, {23,6}, {35,6}, {35,4}, {36,4}, {s="talk",dir="Right"}, {36,5}, {38,5}, {38,4}, {s="lassEther"}, {45,4}, {45,3}},
	-- Save Bill
	{88, {2,7}, {2,5}, {5,5}, {s="dialogue",dir="Right"}, {1,5}, {s="interact",dir="Up"}, {4,5}, {s="talkToBill"}, {s="waitToTalk"}, {s="item",item="escape_rope"}},
	-- Roped back
	{3, {19,18}, {19,17}},
	-- Cerulean Center again
	{64, {3,7}, {3,3}, {s="dialogue",dir="Up"}, {3,8}},
	-- Past the policeman
	{3, {19,18}, {16,18}, {s="dodgeCerulean",left=true}, {8,18}, {8,12}, {27,12}, {27,11}},
	-- Wrecked house
	{62, {2,7}, {2,2}, {3,2}, {3,0}},
	-- Cerulean Rocket
	{3, {27,9}, {c="conserve",move="Bubble-Beam"}, {28,9}, {s="potion",hp=18}, {30,9}, {s="learnInBattle",move="bite",poke="wartortle",replace="bubble"}, {33,9}, {33,18}, {36,18}, {36,31}, {25,31}, {25,36}},
	-- Out of Cerulean
	...
	{74, {4,4}, {3,8}},
	-- Oddish
	{17, {17,14}, {c="a",a="Vermilion City"}, {c="catchOddish"}, {17,15}, {s="potion",hp=10,yolo=7}, {17,19}, {s="catchOddish"}, {11,29}, {s="potion",hp=10,yolo=7}, {11,29}, {s="waitToFight",dir="Down"}, {10,29}, {10,30}, {s="potion",hp=10}, {10,31}, {9,31}, {9,36}},
	-- Enter Vermilion
	...
	-- Rival 3
	{96, {2,4}, {2,11}, {3,11}, {3,12}, {37,12}, {37,9}, {s="swap",item=2,dest="super_potion",chain=true}, {s="teach",move="dig",replace="water_gun",close=true}, {37,8}, {s="rivalSandAttack"}, {36,8}, {36,4}},
	-- Old man Cut
	...
	-- To Surge
	{5, {18,29}, {18,26}, {30,26}, {30,14}, {15,14}, {15,17}, {s="swap",item="repel",dest=0,chain=true}, {s="potion",hp=70,chain=true}, {s="teach",move="cut",poke={"oddish","paras"},chain=true}, {s="skill",move="cut",done=0x0D4D}, {15,20}, {12,20}, {12,19}},
	-- Trashcans
	{92, {4,17}, {c="conserve",move="Bubble-Beam"}, {c="a",a="Surge's Gym"}, {c="potion",b=false}, {4,16}, {2,16}, {2,11}, {s="guess",game="trash",enabled=false}, {s="trashcans"}, {4,6}, {4,3}, {5,3}, {5,2}, {s="talk",dir="Up"}, {s="waitToFight"}, {s="split"}, {s="tweetSurge"}, {4,2}, {4,13}, {5,13}, {5,18}},

-- 8: SURGE

	-- To bicycle house
	{5, {12,20}, {c="a",a="Bicycle Shop"}, {c="potion",b=true}, {15,20}, {15,19}, {s="skill",move="cut",done=0x0D4D}, {15,14}, {9,14}, {9,13}},
	-- Bicycle cert
	{90, {2,7}, {2,5}, {0,5}, {0,1}, {2,1}, {s="dialogue",dir="Right"}, {s="skill",move="dig",map=90}},
	-- Cerulean warp
	{3, {19,18}, {19,23}, {16,23}, {16,26}, {13,26}, {13,25}},
	-- Bicycle shop
	{66, {2,7}, {2,3}, {4,3}, {4,2}, {s="getBicycle"}, {4,7}, {3,7}, {3,8}},
	-- Bicycle out of Cerulean
	--TODO toss?
	{3, {13,26}, {s="swap",item="bicycle",dest=1,chain=true}, {s="potion",hp=20}, {s="bicycle"}, {19,26}, {19,27}, {s="skill",move="cut",done=0x0D4D}, {19,29}, {36,29}, {36,16}, {40,16}},
	-- TPP's Bane
	{20, {0,8}, {c="a",a="Route 9"}, {c="conserve",move="Bubble-Beam"}, {4,8}, {s="skill",move="cut",done=0x0C17,val=2}, {13,8}, {13,9}, {s="talk",dir="Down"}, {12,9}, {12,10}, {s="antidote"}, {12,12}, {23,12}, {23,11}, {29,11}, {29,12}, {41,12}, {41,10}, {40,10}, {40,9}, {s="talk",dir="Up"}, {41,9}, {41,6}, {39,6}, {39,4}, {45,4}, {45,3}, {51,3}, {51,8}, {60,8}},
	-- To the cave
	{21, {0,8}, {3,8}, {3,10}, {13,10}, {13,15}, {14,15}, {14,26}, {3,26}, {3,18}, {7,18}, {s="potion",hp=40}, {s="item",item="repel"}, {8,18}, {8,17}},
	-- Rock Tunnel
	{82, {15,3}, {c="a",a="Rock Tunnel"}, {c="conserve",move="Bubble-Beam"}, {15,6}, {23,6}, {23,7}, {s="talk",dir="Down"}, {22,7}, {22,10}, {37,10}, {37,3}},
	-- B1
	{232, {33,25}, {33,30}, {27,30}, {s="talk",dir="Left"}, {27,31}, {14,31}, {14,30}, {s="potion",hp=40}, {14,29}, {s="talk",dir="Up"}, {s="waitToFight"}, {s="antidote"}, {17,29}, {17,24}, {25,24}, {25,16}, {37,16}, {37,11}, {s="item",item="repel",chain=true}, {s="healParalysis",close=true}, {37,3}, {27,3}},
	-- B2
	...
	-- Out of the Tunnel
	{82, {37,17}, {32,17}, {32,23}, {37,23}, {37,28}, {28,28}, {26,24}, {23,24}, {s="talk",dir="Left"}, {s="waitToFight"}, {s="antidote"}, {23,27}, {15,27}, {15,33}},
	-- To Lavender Town
	...
	-- F2
	{123, {12,2}, {8,2}, {8,5}, {6,5}, {s="shopTM05"}, {5,5}, {s="shopRepels"}, {9,5}, {s="dodgeDepartment"}, {15,2}, {16,2}, {16,1}},
	-- F3
	{124, {16,2}, {12,2}, {12,1}},
	-- F4: Poke Doll
	...
	{136, {16,2}, {12,2}, {12,1}},
	-- Roof
	{126, {15,3}, {12,3}, {s="shopVendWaters"}, {6,3}, {6,4}, {s="giveWater"}, {6,4}, {7,3}, {12,3}, {15,3}, {15,2}},
	-- F5: Buffs
...
-- 9: FLY
	...
	-- Fly to Lavender
	{27, {7,6}, {s="swap",item="x_attack",dest=2,chain=true}, {s="teach",move="fly",poke={"spearow","pidgey"},chain=true}, {s="teach",move="mega_kick",replace="bite",chain=true}, {s="potion",hp=30,chain=true}, {s="teach",move="ice_beam",replace="mega_punch",chain=true}, {s="item",item="super_repel",chain=true}, {s="fly",dest="lavender",map=4}},
	-- To the tower
	{4, {3,6}, {c="a",a="Pokemon Tower"}, {14,6}, {14,5}},
	-- Pokemon Tower
	{142, {10,17}, {10,10}, {18,10}, {18,9}},
	-- F2: Rival
	{143, {18,9}, {c="thrash",disable=true}, {18,7}, {16,7}, {16,5}, {15,5}, {s="fightX",xi="special"}, {s="fightX",xi="accuracy"}, {s="skipLearning"}, {5,5}, {5,8}, {3,8}, {3,9}},
	-- F3
	...
	-- F7: Top
	{148, {9,16}, {10,16}, {10,9}, {s="fightX",xi="accuracy"}, {10,7}, {10,4}, {s="interact",dir="Up"}},
	-- Old man's house
...
-- 10: POKéFLUTE
	...
	{190, {0,4}, {8,4}},
	-- Enter Safari City
	{29, {40,8}, {s="item",item="super_repel",chain=true}, {s="bicycle"}, {50,8}},
	-- Safari City
	...
	-- Safari 2
	{217, {0,23}, {4,23}, {4,24}, {20,24}, {20,20}, {s="safariCarbos"}, {12,20}, {12,22}, {11,22}, {10,22}, {s="item",item="super_repel",chain=true}, {s="tossInSafari"}, {s="item",item="carbos",poke="blastoise",close=true}, {9,22}, {9,8}, {12,8}, {12,6}, {17,6}, {17,8}, {20,8}, {s="extraFullRestore"}, {20,3}, {7,3}, {7,5}, {-1,5}},
	-- Safari 3
	...
	-- Silph Co
	{181, {10,17}, {c="a",a="Silph Co."}, {10,11}, {26,11}, {26,0}},
	-- F1
	{207, {24,1}, {26,1}, {26,0}},
	-- F2
	{208, {26,1}, {24,1}, {24,0}},
	...
	{209, {24,1}, {26,1}, {26,0}},
	-- F4
	{210, {26,1}, {26,3}, {13,3}, {s="interact",dir="Left"}, {13,4}, {8,4}, {8,15}, {s="talk",dir="Down"}, {9,15}},
	-- F9
	...
	-- Giovanni
	{235, {3,2}, {c="a",a="Silph Giovanni"}, {3,11}, {2,11}, {2,15}, {s="rareCandyGiovanni"}, {2,16}, {s="talk",dir="Right"}, {2,15}, {5,15}, {s="potion",hp=17,yolo=12}, {6,15}, {6,14}, {s="interact",dir="Up"}, {6,13}, {s="fightX",xi="accuracy"}, {s="fightSilphGiovanni"}, {s="split"}, {s="skill",move="dig",map=235}},
...
-- 12: KOGA
	...
	{0, {5,6}, {s="item",item="super_repel",chain=true}, {s="item",item="rare_candy",poke="nidoking",all=true,chain=true}, {s="bicycle"}, {c="allowDeath",on=false}, {3,6}, {s="dodgeGirl"}, {3,17}, {s="skill",move="surf",dir="Right"}, {4,18}},
	-- To Cinnabar
	...
	{216, {23,22}, {23,15}, {21,15}, {s="item",item="super_repel",chain=true}, {s="item",item="carbos",poke="nidoking",close=true}, {17,15}, {17,19}, {18,19}, {18,23}, {17,23}, {17,26}, {18,26}, {s="dialogue",dir="Up"}, {14,26}, {14,22}, {12,22}, {12,15}, {24,15}, {24,18}, {26,18}, {26,6}, {24,6}, {24,4}, {20,4}, {s="dialogue",dir="Up"}, {24,4}, {24,6}, {12,6}, {12,2}, {11,2}, {s="take",dir="Left"}, {12,2}, {12,7}, {4,7}, {4,9}, {2,9}, {s="take",dir="Left"}, {5,9}, {5,10}, {s="teach",move="strength",poke="",replace="",chain=true}, {s="item",item="rare_candy",all=true,poke="nidoking",close=true}, {5,12}, {s="take",dir="Down"}, {5,12}, {s="skill",move="dig",map=216}},
	-- Celadon once again
