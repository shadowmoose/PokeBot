...
-- 1: NIDORAN
	...
	-- Viridian Forest
	{51, {16,47}, {c="trackEncounters",area="forest"}, {16,44}, {18,44}, {18,42}, {26,42}, {27,34}, {27,33}, {s="leerCaterpies"}, {s="checkNidoranStats"}, {s="potion",hp=9}, {27,32}, {31,32}, {31,18}, {25,18}, {25,12}, {26,12}, {26,9}, {17,9}, {17,16}, {15,16}, {s="potion",hp=12}, {13,16}, {s="interact",dir="Down"}, {s="leerMetapod"}, {s="potion",hp=9}, {13,3}, {6,3}, {6,22}, {2,22}, {2,19}, {s="potion",hp=12}, {s="interact",dir="Up"}, {s="debuff",{"caterpie",9}}, {1,19}, {1,16}, {1,-1}},
	-- Forest exit
	{47, {4,7}, {4,1}, {5,1}, {5,0}},
	-- Road to Pewter City
	{13, {3,11}, {3,8}, {8,8}, {8,-1}},
...
-- 2: BROCK
	...
	-- Bypass
	{14, {0,9}, {11,9}, {11,5}, {18,5}, {18,4}, {22,4}, {22,5}, {24,5}, {s="interact",dir="Down"}, {s="evolveInBattle"}, {27,5}, {27,9}, {s="catchFlierBackup"}, {37,8}, {37,5}, {49,5}, {49,10}, {57,10}, {57,8}, {59,8}, {59,-1}},
	-- To the Center
...
-- 7: MISTY
	...
	-- Rival 3
	{96, {2,4}, {c="disabled",move="Thrash"}, {2,11}, {3,11}, {3,12}, {37,12}, {37,9}, {s="potion",hp=14,yolo=8,chain=true}, {s="teach",move="bubblebeam",replace="leer",close=true}, {37,8}, {36,8}, {36,4}},
	-- Old man Cut
	{101, {0,7}, {c="disabled",move=nil}, {0,4}, {4,4}, {4,3}, {s="interact",dir="Up"}, {4,5}, {0,5}, {0,7}},
	-- Second deck out
...
-- 9: FLY
	...
	-- F2: Rival
	{143, {18,9}, {c="disabled",move="Thrash"}, {18,7}, {16,7}, {16,5}, {15,5}, {s="lavenderRival"}, {5,5}, {5,8}, {3,8}, {3,9}},
	-- F3
	...
	-- F7: Top
	{148, {9,16}, {10,16}, {10,12}, {s="fightX",xi="accuracy"}, {10,4}, {s="interact",dir="Up"}},
	-- Old man's house
...
-- 10: POKéFLUTE
	...
	-- Giovanni
	{235, {3,2}, {c="a",a="Silph Giovanni"}, {3,14}, {5,14}, {s="potion",hp=52,yolo=32}, {6,14}, {s="interact",dir="Up"}, {6,13}, {s="fightX",xi="attack"}, {s="waitToFight"}, {s="split"}, {s="skill",move="dig",map=235}},
...
-- 11: SILPH CO.
	...
	-- Erika
	{134, {4,17}, {c="a",a="Erika's Gym"}, {4,16}, {1,16}, {1,9}, {0,9}, {0,4}, {1,4}, {s="skill",move="cut",done=0x0D4D}, {3,4}, {s="waitToFight"}, {4,4}, {s="talk",dir="Up",long=true}, {s="fightX",xi="special"}, {s="waitToFight"}, {s="split"}, {5,4}, {5,6}, {s="skill",move="cut",dir="Down",done=0x0D4D}, {5,18}},
...
-- 14: BLAINE
	...
	-- Giovanni Gym
	{45, {16,17}, {c="potion",b=false}, {c="a",a="Giovanni's Gym Machokes"}, {16,16}, {14,16}, {14,9}, {13,9}, {13,7}, {15,7}, {15,4}, {12,4}, {12,5}, {11,5}, {s="potion",hp=25,yolo=0}, {10,5}, {c="a",a="Machoke"}, {10,4}, {s="fightX",xi="special"}, {13,5}, {13,4}, {15,4}, {15,7}, {13,7}, {13,11}, {14,11}, {14,16}, {16,16}, {16,18}},
	-- Reset Gym
