...
-- 4: ROUTE 3
	...
	-- Mt. Moon F1
	{59, {14,35}, {c="a",a="Mt. Moon"}, {c="trackEncounters",area="moon"}, {c="startMtMoon"}, {c="catchParas"}, {c="moon1Exp"}, {14,29}, {5,29}, {5,31}, {s="take",dir="Down"}, {9,31}, {9,24}, {14,24}, {14,22}, {21,22}, {21,15}, {24,15}, {24,27}, {25,27}, {25,31}, {s="talk",dir="Left"}, {c="moon2Exp"}, {25,32}, {33,32}, {33,31}, {34,31}, {s="take",dir="Right"}, {35,31}, {35,23}, {s="take",dir="Right"}, {35,3}, {17,3}, {17,11}},
	-- Detour
	{60, {25,9}, {25,11}, {17,11}},
	-- Mega Punch
	{61, {25,9}, {28,9}, {28,5}, {s="take",dir="Right"}, {28,6}, {28,9}, {25,9}},
	-- Back Up
	{60, {17,11}, {25,9}, {25,11}},
	-- Mt. Moon F1
	{59, {17,11}, {17,17}, {2,17}, {2,3}, {s="take",dir="Up"}, {5,3}, {5,5}},
	-- Mt. Moon B2
	{60, {5,5}, {5,17}, {21,17}},
	-- Mt. Moon B3
	{61, {21,17}, {22,17}, {23,17}, {23,14}, {27,14}, {27,16}, {33,16}, {33,14}, {36,14}, {36,24}, {32, 24}, {32,31}, {10,31}, {10,17}, {11,17}, {s="evolveInBattle"}, {12,17}, {c="moon3Exp"}, {12,9}, {s="teach",move="water_gun",replace="leer",chain=true}, {s="evolveNidoking",chain=true}, {s="potion",hp=11,yolo=6,chain=true}, {s="teach",move="mega_punch",replace="tackle",close=true}, {s="talk",dir="Up"}, {s="fightGrimer"}, {13,9}, {c="moon3Exp"}, {13,7}, {s="dialogue",dir="Up"}, {13,5}, {12,5}, {12,4}, {3,4}, {3,7}, {5,7}},
	-- Mt. Moon escape
	{60, {23,3}, {27,3}},
...
-- 9: FLY
	...
	-- F7: Top
	{148, {9,16}, {10,16}, {10,9}, {s="fightX",xi="accuracy"}, {c="disabled",move=nil}, {10,7}, {s="thunderboltFirst"}, {10,4}, {s="interact",dir="Up"}},
	-- Old man's house
